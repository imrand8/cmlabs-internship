        ...
        <div>
          ...
          {isSinglePageOpen && (
            <div className="ml-3 mt-1 space-y-1">
              {/* Home item */}
              <Link
                href="/Dashboard/content-builder/home"
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M3 12l9-7 9 7v7a2 2 0 01-2 2h-4a2 2 0 01-2-2v-3H9v3a2 2 0 01-2 2H5a2 2 0 01-2-2v-7z"
                  />
                </svg>
                <span>Home</span>
              </Link>
